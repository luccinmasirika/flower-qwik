...
export const App = component$(() => {
  ...
  return (
    <div class="my-app p-20">
      <Logo />
      <h1 class="text-3xl mb-2 text-red-600">Congratulations Qwik is working!</h1>
      <h2 class="text-2xl my-1">Next steps:</h2>
      <ol class="list-decimal list-inside ml-10">
        <li>
          Open dev-tools network tab and notice that no JavaScript was downloaded to render this page. (Zero JavaScript
          no matter the size of your app.)
        </li>
        <li>
        ...
        <li>
          Notice that Qwik automatically lazily-loaded and resumed the component upon interaction without the developer
          having to code that behavior. (Lazy hydration is what gives even large apps instant on behavior.)
        </li>
        <li>
